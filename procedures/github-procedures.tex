...
\begin{tikzpicture}[node distance = 1.5cm,every node/.style={scale=0.8}]
	...
	\node (start) [startstop] {Go to your dot ssh directory ~/.ssh/id\_ssh};
	...
	\node (activate) [startstop,below of=pub] {To activate the key pair, go to your local github repo directory and type: .ssh/id\_rsa/name\_of\_your\_private\_key};
